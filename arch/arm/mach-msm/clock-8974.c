...
static struct clk_lookup msm_clocks_8974_common[] __initdata = {
	...
	CLK_LOOKUP("iface_clk", gcc_blsp1_ahb_clk.c, "f9924000.i2c"),			//ASUS_BSP : Touch
	CLK_LOOKUP("iface_clk", gcc_blsp1_ahb_clk.c, "f9925000.i2c"),			//ASUS_BSP : Mydp
	CLK_LOOKUP("iface_clk", gcc_blsp1_ahb_clk.c, "f9926000.i2c"),			//ASUS_BSP : Camera
	CLK_LOOKUP("iface_clk", gcc_blsp1_ahb_clk.c, "f9928000.i2c"),			//ASUS_BSP : Pad bus
	CLK_LOOKUP("iface_clk", gcc_blsp1_ahb_clk.c, "f991e000.serial"),
	
	CLK_LOOKUP("core_clk", gcc_blsp1_qup1_i2c_apps_clk.c, ""),
	CLK_LOOKUP("core_clk", gcc_blsp1_qup2_i2c_apps_clk.c, "f9924000.i2c"),//ASUS_BSP : Touch
	CLK_LOOKUP("core_clk", gcc_blsp1_qup3_i2c_apps_clk.c, "f9925000.i2c"),//ASUS_BSP : Mydp
	CLK_LOOKUP("core_clk", gcc_blsp1_qup4_i2c_apps_clk.c, "f9926000.i2c"),//ASUS_BSP : Camera
	CLK_LOOKUP("core_clk", gcc_blsp1_qup5_i2c_apps_clk.c, ""),
	CLK_LOOKUP("core_clk", gcc_blsp1_qup6_i2c_apps_clk.c, "f9928000.i2c"),//ASUS_BSP : Pad bus
	...
	CLK_LOOKUP("iface_clk", gcc_blsp2_ahb_clk.c, "f9966000.i2c"),			//ASUS_BSP : NFC, ON_semi_vibrator
	CLK_LOOKUP("iface_clk", gcc_blsp2_ahb_clk.c, "f9968000.i2c"),			//ASUS_BSP : Sensors
	CLK_LOOKUP("iface_clk", gcc_blsp2_ahb_clk.c, "f9965000.spi"),			//ASUS_BSP : Camera
	...
	CLK_LOOKUP("core_clk", gcc_blsp2_qup4_i2c_apps_clk.c, "f9966000.i2c"),//ASUS_BSP : NFC, ON_semi_vibrator
	CLK_LOOKUP("core_clk", gcc_blsp2_qup5_i2c_apps_clk.c, ""),
	CLK_LOOKUP("core_clk", gcc_blsp2_qup6_i2c_apps_clk.c, "f9968000.i2c"),//ASUS_BSP : Sensors
	
	CLK_LOOKUP("core_clk", gcc_blsp2_qup1_spi_apps_clk.c, ""),	
	CLK_LOOKUP("core_clk", gcc_blsp2_qup2_spi_apps_clk.c, ""),
	CLK_LOOKUP("core_clk", gcc_blsp2_qup3_spi_apps_clk.c, "f9965000.spi"),//ASUS_BSP : Camera
	...
	CLK_LOOKUP("ref_clk", diff_clk.c, "slimport"),//+++ ASUS BSP Bernard, mydp use
...
/* MM sensor clocks */
	...
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "6c.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "90.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "3c.qcom,camera"), //ASUS_BSP +++ LiJen "[A86][Camera][NA][Others]Camera mini porting"
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "4-003c"), //ASUS_BSP +++ LiJen "[A86][Camera][NA][Others]Camera mini porting"
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6a.qcom,camera"), //ASUS_BSP +++ LiJen "[A86][Camera][NA][Others]Camera mini porting"
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "4-006a"), //ASUS_BSP +++ LiJen "[A86][Camera][NA][Others]Camera mini porting"
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "6e.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "20.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk2_clk.c, "6c.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk1_clk.c, "90.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "3c.qcom,camera"), //ASUS_BSP +++ LiJen "[A86][Camera][NA][Others]Camera mini porting"
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "4-003c"), //ASUS_BSP +++ LiJen "[A86][Camera][NA][Others]Camera mini porting"
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "6a.qcom,camera"), //ASUS_BSP +++ LiJen "[A86][Camera][NA][Others]Camera mini porting"
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "4-006a"), //ASUS_BSP +++ LiJen "[A86][Camera][NA][Others]Camera mini porting"

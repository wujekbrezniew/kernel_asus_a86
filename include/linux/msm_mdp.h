...
#define MSMFB_RELEASE_ALL      _IOW(MSMFB_IOCTL_MAGIC, 176, int)
#define MSMFB_SET_PADSTATE     _IOW(MSMFB_IOCTL_MAGIC, 177, int)
#define MSMFB_GET_PADSTATE     _IOR(MSMFB_IOCTL_MAGIC, 178, int)
#define MSMFB_GET_BOOTINPAD    _IOR(MSMFB_IOCTL_MAGIC, 179, int)
//Mickey---

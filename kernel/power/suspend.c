...
static int suspend_enter(suspend_state_t state, bool *wakeup)
{
	...
	if(AX_MicroP_IsP01Connected() && (gpio_get_value(9) == 0)){
			printk("[PM]Pad power key is triggered, pin level: %s, wait for completion\n", gpio_get_value(9) ? "High" : "Low");
			goto Pad_powerkey_trigger;	
	}	
#endif
...
extern void asus_dwc3_host_power_off(void);
//ASUS_BSP--- BennyCheng "add none mode switch for storage case"

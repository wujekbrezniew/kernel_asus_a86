...
//wendy4_wang++
    ...
    printk("%s:  MIC2_BIAS_EN %d \n", __func__, wcd9320_hs_data.hsmic_bias);
    if (g_ASUS_hwID == A86_EVB)
        wcd9320_hs_data.hs_path_en = of_get_named_gpio(pdev->dev.of_node, "qcom,hs_path_en",0);

...
int wrap_enabled;
uint16_t wrap_count;
extern int ASUS_SMD_APPS ;  //ASUS_BSP + Yujoe "[A60K][Diag][N/A][Improve]Improve the process of saving QXDM log to SD card."
...
static int diag_smd_probe(struct platform_device *pdev)
{
	...
	if (pdev->id == SMD_APPS_MODEM) {
		...
		ASUS_SMD_APPS = 1;
		pr_err("diag: diag_smd_probe SMD_APPS_MODEM\n");
		//ASUS_BSP --- Yujoe "[A60K][Diag][N/A][Improve]Improve the process of saving QXDM log to SD card."
	}

...
int ASUS_SMD_APPS = 0;  //ASUS_BSP + Yujoe "[A60K][Diag][N/A][Improve]Improve the process of saving QXDM log to SD card."
			   ...
			   unsigned int iocmd, unsigned long ioarg)
{
	...
	if((ASUS_SMD_APPS != 1) && (!strncmp(current->comm,"diag_mdlog",10))){
        return 2;
	}
	//ASUS_BSP --- Yujoe "[A60K][Diag][N/A][Improve]Improve the process of saving QXDM log to SD card."

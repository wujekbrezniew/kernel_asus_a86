...
static const char * const iio_chan_type_name_spec[] = {
	...
	[IIO_QUATERNION] = "quaternion",    //ASUS_BSP ++  Alian_SHen "Porting 9-axis sensor"
};
...
static const char * const iio_modifier_names[] = {
	...
	[IIO_MOD_LIGHT_IR] = "ir",
	[IIO_MOD_R]  = "r", //ASUS_BSP ++ Alian_SHen "Porting 9-axis sensor"
};
			   ...
			   bool generic)
{
	...
	if (writefunc) {
		dev_attr->attr.mode |= S_IWUGO; //ASUS_BSP ++ Alian_Shen "Porting 9-axis sensor"
